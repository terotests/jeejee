...
(function () {
  ...
  var _e_prototype = function _e_prototype() {
    ...
    (function (_myTrait_) {
       ...
       */
      _myTrait_._findEventHandler = function (id, eventName) {
        var obj, list;
        if ((obj = _eventHandlers[id]) && (list = obj[eventName])) {
          return list;
        }
      };
       ...
       * @param function ef  - Event handler function
       */
    ...
    (function (_myTrait_) {
      ...
      _myTrait_.blur = function (t) {
        ...
        console.warning("Blur is not implemented with vdom");
      ...
      _myTrait_.focus = function (t) {
        ...
        console.warning("Focus is not implemented with vdom");
    ...
    var _qc_prototype = function _qc_prototype() {
      ...
      (function (_myTrait_) {
        ...
        _myTrait_.bindSysEvent = function (en, fn, stop) {
          ...
          console.warning("bindSysEvent not implemented in _v");

          return;
          // no warning here given...
         ...
         */
        _myTrait_.blur = function (t) {
          console.warning("blur not implemented in _v");
          // if(this._dom.blur) this._dom.blur();
        };
        ...
        _myTrait_.css = function (n, v) {
          ...
          // ---
          console.warning("CSS not implemented in _v");
    ...
    (function (_myTrait_) {
       ...
       * @param float t
       */
      _myTrait_._domRender = function (t) {
      ...
      /**
       * @param Boolean isOn  - Testing batch mode
       */
      _myTrait_._setBatchMode = function (isOn) {
        _batchMode = isOn;
      };
          ...
          later().onFrame(function () {
            ...
            for (var n in _mountedNodes) {
              ...
              if (!mount.prevState) {
                ...
                console.log("did run the renderer");
                continue;
              }
            ...
            for (var bid in _batchDOM) {
              ...
              if (node && _mountedNodes[node._lid]) {
                console.log("will call the renderer");
      ...
      /**
       * @param float elemName
       * @param float attributes
       * @param float childConstructor
       * @param float elemStateData
       */
      _myTrait_.initAsTag = function (elemName, attributes, childConstructor, elemStateData) {
      ...
      /**
       * @param Object DOMElement  - DOM element to mount to
       */
      _myTrait_.mount = function (DOMElement) {
